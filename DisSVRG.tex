...
%Conventionally, each $f_i(\omega)$ in the optimization problem \ref{equa_loss_minimization} is a $L$-smooth function. That is, there exist a non-negative $L$, and for every $a$ and $b$, the following inequality holds.
%
%\begin{equation}
%\label{equa_l_smooth}
...
% \end{equation}
%
%Besides, the loss function $f(\omega)$  in the optimization problem \ref{equa_loss_minimization} is $\gamma$-strongly convex, which means that there exists a non-negative $\gamma$, and for every $a$ and $b$, the following inequality holds.
%
%\begin{equation}
